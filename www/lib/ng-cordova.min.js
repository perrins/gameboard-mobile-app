...
!function () {
	angular.module("ngCordova", ["ngCordova.plugins"]), angular.module("ngCordova.plugins.actionSheet", []).factory("$cordovaActionSheet", ["$q", "$window", function (e, n) {
		...
		this.setAppUrl = function (e, n) {
			var r = ["ios", "android", "blackberry", "windows8"];
			-1 !== r.indexOf(e) ? AppRate.preferences.storeAppURL[e] = n : alert("wrong device type")
	...
	}]), angular.module("ngCordova.plugins.batteryStatus", []).factory("$cordovaBatteryStatus", ["$rootScope", "$window", function (e, n) {
		var r = e.$new();
		return n.addEventListener("batterystatus", function (e) {
			r.$broadcast("batterystatus", e)
		}, !1), n.addEventListener("batterycritical", function (e) {
			r.$broadcast("batterycritical", e)
		}, !1), n.addEventListener("batterylow", function (e) {
			r.$broadcast("batterylow", e)
		}, !1), r
		...
		return {
			...
			}, notify: function (n, r, t) {
				var o = e.defer();
				return ble.notify(n, r, t, function (e) {
					o.resolve(e)
				}, function (e) {
					o.reject(e)
				}), o.promise
			}, indicate: function (n, r, t) {
				var o = e.defer();
				return ble.indicate(n, r, t, function (e) {
					o.resolve(e)
				}, function (e) {
					o.reject(e)
				}), o.promise
		...
		return {
			createCalendar: function (r) {
				...
				var t = e.defer(), o = [], i = window.plugins.calendar.getCalendarOptions(), a = {
					title: null,
					location: null,
					notes: null,
					startDate: null,
		...
		return {
			show: function (r) {
				...
				var t = n.defer();
				return e.datePicker.show(r, function (e) {
					t.resolve(e)
				}), t.promise
			}
		}
		...
		return {
			getCurrentHeading: function () {
				...
				var r = e.defer(), t = navigator.compass.watchHeading(function (e) {
					r.notify(e)
				}, function (e) {
					r.reject(e)
				}, n);
				return r.promise.cancel = function () {
					navigator.compass.clearWatch(t)
				}, r.promise.clearWatch = function (e) {
					navigator.compass.clearWatch(e || t)
				}, r.promise.watchID = t, r.promise
			}, clearWatch: function (e) {
		...
		return {
			alert: function (r, t, o) {
				...
				return n.navigator.notification ? navigator.notification.confirm(r, function (e) {
					i.resolve(e)
				}, t, o) : i.resolve(n.confirm(r) ? 1 : 2), i.promise
	...
	}]), angular.module("ngCordova.plugins.file", []).factory("$cordovaFile", ["$q", "$window", "$log", "$timeout", function (e, n, r, t) {
		function o(e) {
		...
		function i(n, r) {
			var t = e.defer();
			return c(n, r).then(function (e) {
				e.file(t.resolve, t.reject)
			}, t.reject), t.promise
		}
		...
		function a(n, r) {
			var t = e.defer();
			return c(n, r).then(function (e) {
				e.createWriter(t.resolve, t.reject)
			}, t.reject), t.promise
		}
		...
		function c(n, r) {
			...
			return l().then(function (e) {
				e.root.getFile(n, r, t.resolve, t.reject)
			}, t.reject), t.promise
		}

		function u(r) {
			var t = e.defer();
			return n.resolveLocalFileSystemURL(r, function (e) {
				e.file(t.resolve, t.reject)
			}, t.reject), t.promise
		}
		...
		function s(n, r) {
			var t = e.defer();
			return l().then(function (e) {
				e.root.getDirectory(n, r, t.resolve, t.reject)
			}, t.reject), t.promise
		}
			...
			checkDir: function (e) {
				...
				return s(n, {create: !1}).then(function (e) {
					...
					t.readEntries(function (e) {
						...
						r.reject("DIR_READ_ERROR : " + n)
					})
				}, function () {
					r.reject("DIR_NOT_FOUND : " + n)
				}), r.promise
			}, checkFile: function (e) {
				return 2 == arguments.length && (e = "/" + e + "/" + arguments[1]), c(e, {create: !1})
			}, createFile: function (e, n) {
				return 3 == arguments.length && (e = "/" + e + "/" + arguments[1], n = arguments[2]), c(e, {
					create: !0,
					exclusive: n
				})
				...
				return 2 == arguments.length && (n = "/" + n + "/" + arguments[1]), c(n, {create: !1}).then(function (e) {
					e.remove(r.resolve, r.reject)
				}, r.reject), r.promise
			}, writeFile: function (n, r, t) {
				var o = e.defer();
				return a(n, {create: !0}).then(function (e) {
					t && t.append === !0 && e.seek(e.length), e.onwriteend = function (e) {
						this.error ? o.reject(this.error) : o.resolve(e)
					}, e.write(r)
				}, o.reject), o.promise
			}, readFile: function (e) {
				return r.log("readFile is now deprecated as of v0.1.4-alpha, use readAsText instead"), this.readAsText(e)
				...
				var r = e.defer();
				return 2 == arguments.length && (n = "/" + n + "/" + arguments[1]), i(n, {create: !1}).then(function (e) {
					o(r).readAsBinaryString(e)
				}, r.reject), r.promise
			}, readAsArrayBuffer: function (n) {
				var r = e.defer();
				return 2 == arguments.length && (n = "/" + n + "/" + arguments[1]), i(n, {create: !1}).then(function (e) {
					o(r).readAsArrayBuffer(e)
				}, r.reject), r.promise
				...
				return u(e)
			}, downloadFile: function (n, r, t, o) {
				var i = e.defer(), a = new FileTransfer, c = encodeURI(n);
				return a.onprogress = i.notify, a.download(c, r, i.resolve, i.reject, t, o), i.promise
			}, uploadFile: function (n, r, o) {
				var i = e.defer(), a = new FileTransfer, c = encodeURI(n);
				return void 0 !== o.timeout && null !== o.timeout && (t(function () {
					a.abort()
				}, o.timeout), o.timeout = null), a.onprogress = i.notify, a.upload(r, c, i.resolve, i.reject, o), i.promise
			}
		}
		...
		return {
			...
			}, addTransactionItem: function (r, t, o, i, a, c, u) {
				var s = e.defer();
				return n.analytics.addTransactionItem(r, t, o, i, a, c, u, function (e) {
					s.resolve(e)
				}, function (e) {
					s.reject(e)
				}), s.promise
	...
	}]), angular.module("ngCordova.plugins.inAppBrowser", []).factory("$cordovaInAppBrowser", ["$rootScope", "$q", "$window", function (e, n, r) {
		var t, o, i = e.$new();
		return {
			init: function (e) {
				...
				var c = n.defer();
				return t = r.open(e, a, o), t.addEventListener("loadstart", function (e) {
					i.$emit("loadstart", e)
				}, !1), t.addEventListener("loadstop", function (e) {
					c.resolve(e), i.$emit("loadstop", e)
				}, !1), t.addEventListener("loaderror", function (e) {
					c.reject(e), i.$emit("loaderror", e)
				}, !1), t.addEventListener("exit", function (e) {
					i.$emit("exit", e)
				}, !1), c.promise
			}, close: function () {
				t.close()
				...
				var r = n.defer();
				return t.executeScript(e, function (e) {
					r.resolve(e)
				}), r.promise
			}, insertCSS: function (e) {
				var r = n.defer();
				return t.insertCSS(e, function (e) {
					r.resolve(e)
				}), r.promise
			}
		}
		...
		if ("Keychain"in n)var r = new Keychain;
		return {
			getForKey: function (n, t) {
				...
				var i = e.defer();
				return r.setForKey(i.resolve, i.reject, n, t, o), i.promise
			}, removeForKey: function (n, t) {
				var o = e.defer();
				return r.removeForKey(o.resolve, o.reject, n, t), o.promise
			}
		}
	}]), angular.module("ngCordova.plugins.localNotification", []).factory("$cordovaLocalNotification", ["$q", "$window", "$rootScope", function (e, n, r) {
		return n.plugin && n.plugin.notification && (n.plugin.notification.local.oncancel = function (e, n, t) {
			var o = {id: e, state: n, json: t};
			r.$apply(function () {
				r.$broadcast("localNotification:canceled", o)
			})
		}, n.plugin.notification.local.onclick = function (e, n, t) {
			var o = {id: e, state: n, json: t};
			r.$apply(function () {
				r.$broadcast("localNotification:clicked", o)
			})
		}, n.plugin.notification.local.ontrigger = function (e, n, t) {
			var o = {id: e, state: n, json: t};
			r.$apply(function () {
				r.$broadcast("localNotification:triggered", o)
			})
		}, n.plugin.notification.local.onadd = function (e, n, t) {
			var o = {id: e, state: n, json: t};
			r.$apply(function () {
				r.$broadcast("localNotification:added", o)
			})
		}), {
			add: function (r, t) {
				var o = e.defer();
				return t = t || this, n.plugin.notification.local.add(r, function (e) {
					o.resolve(e)
				}, t), o.promise
			}, cancel: function (r, t) {
				var o = e.defer();
				return t = t || this, n.plugin.notification.local.cancel(r, function (e) {
					o.resolve(e)
				}, t), o.promise
			}, cancelAll: function (r) {
				var t = e.defer();
				return r = r || this, n.plugin.notification.local.cancelAll(function (e) {
					t.resolve(e)
				}, r), t.promise
			}, isScheduled: function (r, t) {
				var o = e.defer();
				return t = t || this, n.plugin.notification.local.isScheduled(r, function (e) {
					o.resolve(e)
				}, t), o.promise
				...
				var o = e.defer();
				return n.plugin.notification.local.isTriggered(r, function (e) {
					o.resolve(e)
				}, t), o.promise
	...
	}]), angular.module("ngCordova.plugins.network", []).factory("$cordovaNetwork", ["$rootScope", "$document", function (e) {
		return {
			getNetwork: function () {
		...
		return {
			dropbox: function (n) {
				var r = e.defer();
				if (window.cordova) {
					var t = cordova.require("cordova/plugin_list").metadata;
					if (t.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
						...
						o.addEventListener("loadstart", function (e) {
							if (0 === e.url.indexOf("http://localhost/callback")) {
								for (var n = e.url.split("#")[1], t = n.split("&"), i = [], a = 0; a < t.length; a++)i[t[a].split("=")[0]] = t[a].split("=")[1];
								if (void 0 !== i.access_token && null !== i.access_token) {
									var c = {access_token: i.access_token, token_type: i.token_type, uid: i.uid};
									r.resolve(c)
								} else r.reject("Problem authenticating");
								o.close()
							}
				...
				if (window.cordova) {
					...
					if (o.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
						var i = window.open("https://accounts.google.com/o/oauth2/auth?client_id=" + n + "&redirect_uri=http://localhost/callback&scope=" + r.join(" ") + "&approval_prompt=force&response_type=token", "_blank", "location=no,clearsessioncache=yes,clearcache=yes");
						i.addEventListener("loadstart", function (e) {
							if (0 === e.url.indexOf("http://localhost/callback")) {
								...
								if (void 0 !== o.access_token && null !== o.access_token) {
									{
										({access_token: o.access_token, token_type: o.token_type, uid: o.uid})
									}
									t.resolve({
					...
					if (a.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
						...
						c.addEventListener("loadstart", function (e) {
							if (0 === e.url.indexOf("http://localhost/callback")) {
								...
								n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n.defaults.headers.post.Accept = "application/json", n({
									method: "post",
									url: "https://github.com/login/oauth/access_token",
									data: "client_id=" + r + "&client_secret=" + t + "&redirect_uri=http://localhost/callback&code=" + o
								}).success(function (e) {
									i.resolve(e)
								}).error(function () {
				...
				return i.promise
			}, facebook: function (n, r) {
				var t = e.defer();
				if (window.cordova) {
					var o = cordova.require("cordova/plugin_list").metadata;
					if (o.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
						var i = window.open("https://www.facebook.com/dialog/oauth?client_id=" + n + "&redirect_uri=http://localhost/callback&response_type=token&scope=" + r.join(","), "_blank", "location=no,clearsessioncache=yes,clearcache=yes");
						i.addEventListener("loadstart", function (e) {
							if (0 === e.url.indexOf("http://localhost/callback")) {
								for (var n = e.url.split("#")[1], r = n.split("&"), o = [], a = 0; a < r.length; a++)o[r[a].split("=")[0]] = r[a].split("=")[1];
								if (void 0 !== o.access_token && null !== o.access_token) {
									var c = {access_token: o.access_token, expires_in: o.expires_in};
									t.resolve(c)
								} else t.reject("Problem authenticating");
								i.close()
							}
				...
				if (window.cordova) {
					...
					if (c.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
						var u = window.open("https://www.linkedin.com/uas/oauth2/authorization?client_id=" + r + "&redirect_uri=http://localhost/callback&scope=" + o.join(" ") + "&response_type=code&state=" + i, "_blank", "location=no,clearsessioncache=yes,clearcache=yes");
						u.addEventListener("loadstart", function (e) {
							if (0 === e.url.indexOf("http://localhost/callback")) {
								...
								n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n({
									...
									data: "client_id=" + r + "&client_secret=" + t + "&redirect_uri=http://localhost/callback&grant_type=authorization_code&code=" + o
								}).success(function (e) {
									a.resolve(e)
								}).error(function () {
				...
				return a.promise
			}, instagram: function (n, r) {
				var t = e.defer();
				if (window.cordova) {
					var o = cordova.require("cordova/plugin_list").metadata;
					if (o.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
						var i = window.open("https://api.instagram.com/oauth/authorize/?client_id=" + n + "&redirect_uri=http://localhost/callback&scope=" + r.join(" ") + "&response_type=token", "_blank", "location=no,clearsessioncache=yes,clearcache=yes");
						i.addEventListener("loadstart", function (e) {
							if (0 === e.url.indexOf("http://localhost/callback")) {
								for (var n = e.url.split("#")[1], r = n.split("&"), o = [], a = 0; a < r.length; a++)o[r[a].split("=")[0]] = r[a].split("=")[1];
								if (void 0 !== o.access_token && null !== o.access_token) {
									var c = {access_token: o.access_token};
									t.resolve(c)
								} else t.reject("Problem authenticating");
								i.close()
							}
				...
				if (window.cordova) {
					...
					if (a.hasOwnProperty("org.apache.cordova.inappbrowser") === !0)if ("undefined" != typeof jsSHA) {
						var c = {
							...
							oauth_version: "1.0"
						}, u = r.createSignature("POST", "https://api.twitter.com/oauth/request_token", c, {oauth_callback: "http://localhost/callback"}, o);
						n.defaults.headers.post.Authorization = u.authorization_header, n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n({
							...
							for (var t = e.split("&"), a = {}, u = 0; u < t.length; u++)a[t[u].split("=")[0]] = t[u].split("=")[1];
							...
							s.addEventListener("loadstart", function (e) {
								if (0 === e.url.indexOf("http://localhost/callback")) {
									for (var t = e.url.split("?")[1], a = t.split("&"), u = {}, l = 0; l < a.length; l++)u[a[l].split("=")[0]] = a[l].split("=")[1];
									...
									var f = r.createSignature("POST", "https://api.twitter.com/oauth/access_token", c, {oauth_verifier: u.oauth_verifier}, o);
									n.defaults.headers.post.Authorization = f.authorization_header, n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n({
										...
										r.hasOwnProperty("oauth_token_secret") === !1 && i.reject("Oauth access token was not received"), i.resolve(r)
									}).error(function (e) {
										i.reject(e)
									}), s.close()
								}
				...
				if (window.cordova) {
					...
					if (t.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
						...
						o.addEventListener("loadstart", function (e) {
							if (0 === e.url.indexOf("http://localhost/callback")) {
								for (var n = e.url.split("#")[1], t = n.split("&"), i = {}, a = 0; a < t.length; a++)i[t[a].split("=")[0]] = t[a].split("=")[1];
								void 0 !== i.access_token && null !== i.access_token ? r.resolve(i) : r.reject("Problem authenticating"), o.close()
							}
						}), o.addEventListener("exit", function () {
							r.reject("The sign in flow was canceled")
						})
				...
				if (window.cordova) {
					var c = cordova.require("cordova/plugin_list").metadata;
					if (c.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
						var u = window.open(o(n, r, t), "_blank", "location=no,clearsessioncache=yes,clearcache=yes");
						u.addEventListener("loadstart", function (e) {
							if (i(e.url, t)) {
								...
								"undefined" == typeof n || "undefined" == typeof n.access_token ? a.reject("Problem authenticating") : a.resolve(n), u.close()
							}
						}), u.addEventListener("exit", function () {
							a.reject("The sign in flow was canceled")
						})
		...
		return {
			createSignature: function (e, n, r, t, o) {
				if ("undefined" != typeof jsSHA) {
					for (var i = angular.copy(r), a = Object.keys(t), c = 0; c < a.length; c++)i[a[c]] = encodeURIComponent(t[a[c]]);
					var u = e + "&" + encodeURIComponent(n) + "&", s = Object.keys(i).sort();
					for (c = 0; c < s.length; c++)u += encodeURIComponent(c == s.length - 1 ? s[c] + "=" + i[s[c]] : s[c] + "=" + i[s[c]] + "&");
					var l = new jsSHA(u, "TEXT");
					r.oauth_signature = encodeURIComponent(l.getHMAC(encodeURIComponent(o) + "&", "TEXT", "SHA-1", "B64"));
					var f = Object.keys(r), d = "OAuth ";
					for (c = 0; c < f.length; c++)d += c == f.length - 1 ? f[c] + '="' + r[f[c]] + '"' : f[c] + '="' + r[f[c]] + '",';
					return {signature_base_string: u, authorization_header: d, signature: r.oauth_signature}
				}
		...
		return {
			share: function (r, t, o, i) {
				var a = e.defer();
				return n.plugins.socialsharing.share(r, t, o, i, function () {
					a.resolve(!0)
				}, function () {
					a.reject(!1)
				}), a.promise
				...
				var i = e.defer();
				return n.plugins.socialsharing.shareViaTwitter(r, t, o, function () {
					i.resolve(!0)
				}, function () {
					i.reject(!1)
				}), i.promise
				...
				var i = e.defer();
				return n.plugins.socialsharing.shareViaWhatsApp(r, t, o, function () {
					i.resolve(!0)
				}, function () {
					i.reject(!1)
				}), i.promise
				...
				var i = e.defer();
				return n.plugins.socialsharing.shareViaFacebook(r, t, o, function () {
					i.resolve(!0)
				}, function () {
					i.reject(!1)
				}), i.promise
				...
				var u = e.defer();
				return n.plugins.socialsharing.shareViaEmail(r, t, o, i, a, c, function () {
					u.resolve(!0)
				}, function () {
					u.reject(!1)
				}), u.promise
				...
				var c = e.defer();
				return n.plugins.socialsharing.shareVia(r, t, o, i, a, function () {
					c.resolve(!0)
				}, function () {
					c.reject(!1)
				}), c.promise
