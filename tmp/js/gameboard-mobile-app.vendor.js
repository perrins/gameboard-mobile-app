/*!
 * gameboard-mobile-app.bundle.js is a concatenation of vendor file
 */
  ...
  IBMBluemixConfig.prototype = {
    ...
    _parseApplicationRoute: function () {
      ...
      if (newBaasURL.indexOf(this.STAGE1) == -1) {
        newRewriteDomain = this.PRODUCTION_BLUEMIX_DOMAIN;
      } else {
        if (subzone != null && !_.isEqual(subzone, "")) {
          newRewriteDomain = this.STAGE1_SUBZONE_BLUEMIX_DOMAIN.replace("$0", subzone);
        } else {
          newRewriteDomain = this.STAGE1_BLUEMIX_DOMAIN;
        }
      }
 ...
 *  CloudCode Service JavaScript SDK v1.0.0.20140902-1945
 *
 */
